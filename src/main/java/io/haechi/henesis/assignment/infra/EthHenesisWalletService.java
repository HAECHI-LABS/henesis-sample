...
@Service
public class EthHenesisWalletService implements EthKlayHenesisWalletClient {
    ...
    public EthHenesisWalletService(
            ...
            @Qualifier("ethMasterWalletId") String  masterWalletId,
            @Qualifier("ethPassphrase") String passphrase
